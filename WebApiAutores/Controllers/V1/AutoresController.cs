...
namespace WebApiAutores.Controllers.V1
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        [HttpGet(Name = "obtenerAutoresv1")]//api/autores (hereda ruta)
        //(Multiples rutas)
        [AllowAnonymous]
        ...
        [HttpPut("{id:int}", Name = "actualizarAutorv1")]// api/autores/"IdAutor"
        ...
        /// <returns></returns>
        [HttpDelete("{id:int}", Name = "borrarAutorv1")] // api/autores/IdAutor
